  ...
  return (
    <section id="memory" className="relative py-[110px]">
      <div className="max-w-[1120px] mx-auto px-7">
        <Reveal>
          <div className="p-[44px] mt-[44px] glass-panel overflow-hidden relative overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_500px_300px_at_90%_0%,rgba(201,162,39,0.12),transparent_60%)] before:z-0">
