        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-[14px] mt-[44px]">
          {hallOfFame.map((item, index) => (
            <Reveal key={item.id} delay={index * 0.1} className="h-full">
              <div className="text-center p-[28px_16px] glass-panel h-full flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(0,230,118,0.15)] hover:border-[var(--color-gold)]/40 group cursor-default">
                <div>
